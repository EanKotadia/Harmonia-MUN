  ...
  return (
    <div className="min-h-screen bg-bg-dark flex items-center justify-center p-6">
      <div className="max-w-md w-full card-glass p-10 border-accent/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-accent/50 outline-none transition-all"
              required
            />
          </div>
        ...
        <div className="mt-8 p-4 bg-danger/10 border border-danger/20 rounded-2xl flex gap-3">
          <AlertCircle size={18} className="text-danger shrink-0 mt-0.5" />
          <p className="text-[10px] text-danger/80 leading-relaxed uppercase font-bold tracking-widest">
